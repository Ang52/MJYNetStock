...
VALUES ('admin', '123456', '系统管理员', '管理员', '13800138000', TRUE);

-- 插入测试操作员账号
INSERT INTO users (Username, Password, RealName, Role, Phone, IsActive) 
VALUES ('user', '123456', '普通用户', '操作员', '13900139000', TRUE);
...
-- 注意事项
-- 1. 首次运行系统前，请先执行本SQL脚本初始化数据库
-- 2. 默认管理员账号：admin / 123456
-- 3. 默认操作员账号：user / 123456
-- 4. 请根据实际情况修改 Database/DbConfig.cs 中的数据库连接参数
-- 5. 确保MySQL服务已启动
